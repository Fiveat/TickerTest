...
const char* ssid     = "MiFibra-112A";     //Replace "<NETWORK_NAME>" with yours.
const char* password = "cJhc3ygH";  //Replace "<PASSWORD>" with yours.
char chBuffer[128];
...
//Cambiar el valor del bucle, en función del test data superior.
